...
public class InspectionController {
    ...
    public ResponseEntity<InspectionResponseDTO> checkInspectionCondition(
            @Valid @RequestBody InspectionConditionsDTO request) {
        return ResponseEntity.ok(inspectionService.checkInspectionCondition(request));
    }

    @PostMapping("/identification")
    public ResponseEntity<InspectionResponseDTO> vehicleIdentification(
            @Valid @RequestBody VehicleIdentificationDTO request) {
        return ResponseEntity.ok(inspectionService.vehicleIdentification(request));
    }

    @PostMapping("/wheel-tire")
    public ResponseEntity<InspectionResponseDTO> wheelTire(@Valid @RequestBody WheelsInspectionRequestDto request) {
    ...
    public ResponseEntity<InspectionResponseDTO> getBrakeTestStatus(@PathVariable Long inspectionId) {
        return ResponseEntity.ok(inspectionService.getBrakeTestStatus(inspectionId));
    }
